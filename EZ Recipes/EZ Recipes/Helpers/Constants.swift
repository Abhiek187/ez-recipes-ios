...
struct Constants {
    ...
    struct Mocks {
        ...
        static let passkeyCreationOptions = PasskeyCreationOptions(challenge: "u6R7q8xK3eCCmCUpx1HR-WtuV9z2d4FCVlntZFDrsbQ", rp: .init(name: "EZ Recipes Web", id: recipeWebOrigin), user: .init(id: "ccr9dy6B7OXMyeDW0KPEuPZ9MfKkHLtFPbhnscTXhbM", name: "test@email.com", displayName: ""), pubKeyCredParams: [.init(alg: -8, type: "public-key"), .init(alg: -7, type: "public-key"), .init(alg: -257, type: "public-key")], timeout: 60_000, attestation: "none", excludeCredentials: [.init(id: "Xfo96lb073r7xKvCF3fTEg", transports: ["hybrid", "internal"], type: "public-key")], authenticatorSelection: .init(requireResidentKey: true, residentKey: "required", userVerification: "required"), extensions: ["credProps": true], hints: [])
